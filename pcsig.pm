...
[]wait_phase & context_1 & my_turn & state_1=WAIT & timer_1=timeout & inner_state=0 & view_p1_p2>=0 & view_p2_p1>=0 
-> (1-packet_loss_rate):(counter_p1_p2'=send_timer_2) & (view_p1_p2'=send_timer_2) & (turn_token'= turn_token + 1) & (inner_state'=0) & 
(end_process'=1) + (packet_loss_rate): (turn_token'= turn_token + 1) & (inner_state'=0) & (end_process'=1); 
...
-> (phase_token'=0) & (inner_state'=0)  & (state_1'=BROADCAST) 
& (state_2'=BROADCAST) & (turn_token'=0); //line 66

// change the ALL states from WAIT TO BROADCAST 
[] new_phase & phase_token=1 & end_process=0 
-> (phase_token'=phase_token-1) & (inner_state'=0)  & (state_1'=BROADCAST) 
& (state_2'=BROADCAST) & (turn_token'=0); //line 66

//TASK 3
[] new_phase & phase_token=1 & end_process=1 & state_1=WAIT & state_2 = WAIT
& timer_1=timeout & inner_state=0 & view_p1_p2=view_p2_p2 & view_p2_p1=view_p1_p1
...
[] new_phase & phase_token=1 & end_process=1 & state_1=WAIT & state_2 = WAIT 
& timer_1=timeout & (SYNCHRONIZED=false) &  inner_state=8
-> (phase_token'=phase_token-1) & (inner_state'=8)  & (state_1'=BROADCAST) 
& (state_2'=BROADCAST) & (turn_token'=0); 

[] new_phase & phase_token=1 & end_process=1 & state_1=WAIT & state_2 = WAIT 
& timer_1=timeout & (SYNCHRONIZED=true) &  inner_state=8
-> (phase_token'=phase_token-1) & (inner_state'=8)  & (state_1'=BROADCAST) 
& (state_2'=BROADCAST) & (turn_token'=0); 
